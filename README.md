...
Este projeto é um planejador de marketing para Instagram que utiliza a API da Meta para obter dados reais do perfil e o **Google Gemini 2.5 Flash** para gerar estratégias personalizadas e humanizadas, com controle de orçamento de tokens integrado.
...
*   **Uso da IA (Gemini):** A API do Gemini 2.5 Flash é rápida e eficiente. O sistema possui controle automático de orçamento via `MAX_GEMINI_COST`. Consulte `/api/token-status` para monitorar o consumo em tempo real.
