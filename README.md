...
*   **Uso da IA (Gemini):** A API do Gemini 1.5 Flash é rápida e eficiente. O sistema possui controle automático de orçamento via `MAX_GEMINI_COST`. Consulte `/api/token-status` para monitorar o consumo em tempo real.
